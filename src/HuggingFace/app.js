...
const System_Prompt =
  "You are my personal chief assistant ai and i will give you ingredients list items you just take that ingredients or add if you want to add few more ingredients in them and suggest me proper dishes in dinner or may be lunch with proper guidance and instructions step by step in a markdown file format so i render this on my website after doing formatting.";

const huggingFace = new HfInference(apiKey);

async function getRecipe(ingredients) {
  const ingredientsString = ingredients.join(",").split(",");
